...
<body>
        ...
        <div class="row">
            ...
            <div class="col">
                <td style="margin-top:10px">
                    <br>
                    <h2 class="font-weight-bold">Title Product</h2>
                    <h4>Price</h4>
                    <br>
                    <p style="font-size: 18px;">Storage
                    <p>
                        <button type="button" class="btn btn-outline-dark" id="btnSt">
                            <label class=" form-check-label" value="...">6GB+64GB</label>
                        </button>
                        <button type="button" class="btn btn-outline-dark" style="margin-left:10px" id="btnSt">8GB+128GB</button>
                    <p style="font-size: 20px;">Color
                    <p>
                        <button type="button" class="btn btn-outline-dark" id="button-colorname" style="width:160px;height:50px;" class="form-check-btn" for="inlineRadio1">
                        <div class="container">
                        ...
                        <button type="button" class="btn btn-outline-dark" style="margin-left:20px; width:160px;height:50px" id="button-colorname" class="form-check-btn" for="inlineRadio2">
                        <div class="container">
                        ...
                        <button type="button" class="btn btn-outline-dark" style="margin-left:20px;width:160px;height:50px" id="button-colorname" class="form-check-btn" for="inlineRadio3">
                            <div class="container">
                    ...
                    <br>
                    <button type="button" class="btn btn-outline-success" id="chart">
                        <img src=" keranjang2.png" style="width:30px; margin-left:-20px;">
                        Add To Chart
                    </button>
                    <button type="button" class="btn btn-light text-white" id="buy">
                        Buy Now
                    </button>
            </div>
        </div>
            ...
            <a href="" class="cardlink">
                <div class="card" style="color:black">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="text-dark" style="font-weight:bold;">Title Reviews</h5>
                    </div>
                </div>
            </a>
        </div>
    ...
    <div class="container" id="container-Ulasan">
        <div class="card" style="color:black; padding:1em">
            ...
            <div class="Button" id="ButtonUlasan">
                <button type="button" class="btn plus float-right" id="ulasan">Kirim</button>
            </div>
        ...
        <div class="card-footer">
            <div class="container" style="font-size:20px" id="nama-user">
                <br>
                <p style="font-size:20px; font-weight:bold;" class="text-dark">Nama User</p>
                <p style="font-size:14px;" class="text-dark">Rating : 7/10</p>
                <p style="font-size:16px;" class="text-dark">Ulasan User Lorem ipsum dolor sit amet, consectetur adipiscing elit. Leo vulputate ridiculus faucibus sed risus elementum tempus. Lorem pulvinar nulla nunc, senectus. Sit integer proin sed fermentum, sed. Amet curabitur consectetur amet id duis risus sed.
                </p>
                </br>
                <br>
                <p style="font-size:20px; font-weight:bold;" class="text-dark">Nama User</p>
